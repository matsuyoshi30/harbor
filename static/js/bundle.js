...
var bigramTokeniser = function (obj, metadata) {
  ...
  if (Array.isArray(obj)) {
    return obj.map(function (t) {
      return new lunr__WEBPACK_IMPORTED_MODULE_0__["Token"](
        lunr__WEBPACK_IMPORTED_MODULE_0__["utils"].asString(t).toLowerCase(),
        lunr__WEBPACK_IMPORTED_MODULE_0__["utils"].clone(metadata)
      )
    })
  }
 ...
 */
function initLunr () {
  Object(jquery__WEBPACK_IMPORTED_MODULE_1__["getJSON"])('../post/index.json').done(function (index) {
    pagesIndex = index
...
function initUI () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#searchBox').keyup(function () {
        var $searchResults = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#searchResults')
        var query = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#searchBox').val()
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#searchBox').trigger('keyup')
}
...
function renderResults (results) {
  ...
  var instance = new mark_js__WEBPACK_IMPORTED_MODULE_2___default.a(document.querySelector("#searchResults"))
  // Only show the ten first results
  results.slice(0, MAX_PAGES).forEach(function (result, idx) {
    var $searchResultPage = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div class="searchResultPage">')
...
/***/ 0:
/*!**********************************!*\
  !*** multi ./static/src/main.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./static/src/main.js */"./static/src/main.js");
